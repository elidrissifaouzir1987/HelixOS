...
reviewed `helix-task-authority-projections` direct consumer; those four test blobs
are part of the PLAN-006 integration and exact-removal footprint and must be restored
to the clean source versions when PLAN-006 is removed. Fixtures, workflow and
evidence tools are PLAN-006-owned and disappear in the isolated-removal drill.
